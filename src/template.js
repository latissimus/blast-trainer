...
export const TPL = {
  'OK-A': { label: 'OK-A', short: 'OK · Load', sub: 'Oberkörper Loading · Unterkörper Pump', rot: 'A', blocks: [
    ...
    { id: 'p_quad', mus: 'Beine (Thigh)', type: 'pump', sets: [1, 2, 2], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }] },
    // Sheet-Fussnote ‡: Tier I nur ein Satz fuer den schwaecheren von beiden, Tier II/III je einer.
    { id: 'p_gh',   mus: 'Quad + Ham',    type: 'pump', sets: [1, 1, 1], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }, { n: '' }], exByTier: [[{ n: '' }], [{ n: '' }, { n: '' }], [{ n: '' }, { n: '' }]] },
  ...
  'UK-A': { label: 'UK-A', short: 'UK · Load', sub: 'Unterkörper Loading · Oberkörper Pump', rot: 'A', blocks: [
    ...
    { id: 'gh',   mus: 'Ham',         type: 'load', sets: [1, 1, 1], rest: 120, reps: '6–12', ex: [{ r: 'Iso', n: 'BX einbeinig' }] },
