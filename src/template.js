...
export const TPL = {
  ...
  'UK-H': {
    ...
    blocks: [
      ...
      { id: 'quads_iso', mus: 'Quads', konten: ['Quads'], type: 'load', sets: [1, 2, 2], rest: 150, reps: '6–10', rir: '0–2 RIR', ex: [feld('Iso', ['Quads'])] },
      { id: 'hams_glutes_iso', mus: 'Hams/Glutes', konten: ['Hams', 'Glutes'], type: 'load', sets: [1, 2, 2], rest: 150, reps: '6–10', rir: '0–2 RIR', ex: [feld('Iso', ['Hams', 'Glutes'])] },
  ...
  'OK-P': {
    ...
    blocks: [
      ...
      { id: 'delt_iso', mus: 'Seitl./Hint. Schulter', konten: ['Seitliche Schulter', 'Hintere Schulter'], type: 'pump', sets: [2, 3, 3], rest: 90, reps: '15–25', rir: '0–1 RIR', free: 1, ex: [feld('Iso', ['Seitliche Schulter', 'Hintere Schulter'])] },
