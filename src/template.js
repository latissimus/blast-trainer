...
export const TPL = {
  'OK-A': { label: 'OK-A', short: 'OK · Load', sub: 'Oberkörper Loading · Unterkörper Pump', rot: 'A', blocks: [
    ...
    { id: 'p_quad', mus: 'Quads',       type: 'pump', sets: [1, 2, 2], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }] },
    { id: 'p_gh',   mus: 'Glutes/Hams', type: 'pump', sets: [1, 1, 1], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }] },
    { id: 'p_calf', mus: 'Waden',       type: 'pump', sets: [1, 1, 2], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }] },
    { id: 'p_fore', mus: 'Unterarme',   type: 'pump', sets: [1, 1, 2], rest: 60, reps: 'Halt/Wdh', ex: [{ n: 'Fat-Gripz Halt 30–60 s' }, { n: 'Reverse Curls' }] },
  ] },
  'UK-A': { label: 'UK-A', short: 'UK · Load', sub: 'Unterkörper Loading · Oberkörper Pump', rot: 'A', blocks: [
    ...
    { id: 'quad', mus: 'Quads',       type: 'load', sets: [1, 1, 1], rest: 120, reps: '6–12', stretch: 1, ex: [{ r: 'Comp', n: 'Splitsquats FFE' }] },
    { id: 'gh',   mus: 'Glutes/Hams', type: 'load', sets: [1, 1, 1], rest: 120, reps: '10–15', ex: [{ r: 'Iso', n: 'BX einbeinig' }] },
    { id: 'add',  mus: 'Adduktoren',  type: 'load', sets: [1, 1, 1], rest: 120, reps: '10–15', free: 1, ex: [{ r: 'Iso', n: 'Adduktion Kabel / Copenhagen' }] },
    { id: 'calf', mus: 'Waden',       type: 'load', sets: [2, 4, 5], rest: 90,  reps: '8–12', stretch: 1, ex: [{ r: 'Comp', n: 'Wadenheben Multipresse' }] },
    ...
    { id: 'p_arm', mus: 'Bi + Tri',   type: 'pump', sets: [1, 1, 2], rest: 60, reps: '12–20', free: 1, stretch: 1, ex: [{ n: 'Trizeps Überkopf' }, { n: 'Bizeps' }] },
    { id: 'p_fore', mus: 'Unterarme', type: 'pump', sets: [1, 1, 2], rest: 60, reps: 'Halt/Wdh', ex: [{ n: 'Hammer Curls' }, { n: 'Handgelenk-Curls' }] },
  ] },
  ...
  'MRs': { label: 'MRs', short: 'Muscle Rounds', sub: 'Ganzkörper · 6×4 · ~15RM · 10 s zwischen Minisätzen', rot: '*', blocks: [
    ...
    { id: 'm_arm',  mus: 'Tri u/o Bi',    type: 'mr', typeByTier: ['pump', 'mr', 'mr'], sets: [1, 1, 1], rest: 10, reps: '6×4', free: 1, stretch: 1, ex: [{ n: '' }] },
    { id: 'm_gh',   mus: 'Beine (Ham)',   type: 'mr', sets: [1, 1, 1], rest: 10, reps: '6×4', free: 1, ex: [{ n: '' }] },
    { id: 'm_calf', mus: 'Waden / Add.',  type: 'mr', sets: [1, 1, 1], rest: 10, reps: '6×4', free: 1, ex: [{ n: '' }] },
