...
export const TPL = {
  ...
  'UK-A': { short: 'UK · Load', sub: 'Unterkörper Loading · Oberkörper Pump', rot: 'A', blocks: [
  ...
  'OK-B': { short: 'OK · Load', sub: 'Oberkörper Loading · Unterkörper Pump', rot: 'B', blocks: [
    ...
    { id: 'p_gh',   mus: 'Quads + Hams',  type: 'pump', sets: [1, 1, 1], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }, { n: '' }], exByTier: [[{ n: '' }], [{ n: '' }, { n: '' }], [{ n: '' }, { n: '' }]] },
    { id: 'p_calf', mus: 'Waden',         type: 'pump', sets: [1, 1, 2], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }] },  ] },
  'UK-B': { short: 'UK · Load', sub: 'Unterkörper Loading · Oberkörper Pump', rot: 'B', blocks: [
    ...
    { id: 'p_da', mus: 'Schultern + Abs', type: 'pump', sets: [1, 2, 3], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }, { n: '' }] },
    { id: 'p_arm', mus: 'Bi + Tri',   type: 'pump', sets: [1, 1, 2], rest: 60, reps: '15–25', free: 1, stretch: 1, ex: [{ n: '' }, { n: '' }] },  ] },
  'MRs': { short: 'Muscle Rounds', sub: 'Ganzkörper · 6×4 · ~15RM · 10 s zwischen Minisätzen', rot: '*', blocks: [
...
// Cruise (Wochen 7–8): laut PDF S. 82/100 trainiert man 2–3× pro Woche, ausschliesslich
// Muscle Rounds. Drei Slots teilen sich dieselbe Vorlage, damit jede Einheit einzeln
// geloggt wird; der dritte ist optional. Gleiche Referenz genuegt – TPL wird nur gelesen.
TPL['MRs-2'] = TPL['MRs'];
TPL['MRs-3'] = TPL['MRs'];
