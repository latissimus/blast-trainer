...
export const TPL = {
  'OK-H': {
    ...
    blocks: [
      ...
      { id: 'delt_iso', mus: 'Seitl./Hint. Schulter', konten: ['Seitliche Schulter', 'Hintere Schulter'], type: 'load', sets: [2, 2, 2], rest: 150, reps: '6–10', rir: '0–1 RIR', ex: [feld('Iso', ['Seitliche Schulter', 'Hintere Schulter'])] },
