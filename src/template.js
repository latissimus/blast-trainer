...
//
// konten: welche Muskelkonten dieser Block bedienen darf. Steuert zweierlei –
// welche Übungen der Katalog im Auswahlfeld anbietet, und auf welches Konto die
// Sätze später im Wochenkonto laufen. Die Beschriftung (mus) bleibt bewusst grob
// ("Schultern"), die Konten sind fein: Welcher Schulterkopf drankommt, ist eine
// Entscheidung beim Auswählen, keine der Vorlage.
//
...
export const TPL = {
  'OK-A': { short: 'OK · Heavy', sub: 'Oberkörper Heavy · Unterkörper Pump', rot: 'A', blocks: [
    ...
    { id: 'p_gh',   mus: 'Quads + Hams',  konten: ['Quads', 'Hams'], type: 'pump', sets: [1, 1, 1], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }, { n: '' }], exByTier: [[{ n: '' }], [{ n: '' }, { n: '' }], [{ n: '' }, { n: '' }]] },
  ...
  'UK-A': { short: 'UK · Heavy', sub: 'Unterkörper Heavy · Oberkörper Pump', rot: 'A', blocks: [
    ...
    { id: 'p_bk', mus: 'Brust + Rücken',  konten: ['Brust', 'Lat', 'Oberer Rücken'], type: 'pump', sets: [1, 2, 2], rest: 60, reps: '15–25', free: 1, stretch: 1, ex: [{ n: '' }, { n: '' }] },
    { id: 'p_da', mus: 'Schultern + Abs', konten: ['Vordere Schulter', 'Seitliche Schulter', 'Hintere Schulter', 'Abs'], type: 'pump', sets: [1, 2, 3], rest: 60, reps: '15–25', free: 1, ex: [{ n: '' }, { n: '' }] },
    { id: 'p_arm', mus: 'Bi + Tri',   konten: ['Bizeps', 'Trizeps', 'Unterarme'], type: 'pump', sets: [1, 1, 2], rest: 60, reps: '15–25', free: 1, stretch: 1, ex: [{ n: '' }, { n: '' }] },  ] },
  ...
  'MRs': { short: 'Clusters', sub: '6×4 · ~15RM · 10 s zwischen Minisätzen', rot: '*', blocks: [
    ...
    { id: 'm_arm',  mus: 'Tri u/o Bi',    konten: ['Trizeps', 'Bizeps', 'Unterarme'], type: 'mr', typeByTier: ['pump', 'mr', 'mr'], sets: [1, 1, 1], rest: 10, reps: '6×4', free: 1, stretch: 1, ex: [{ n: '' }, { n: '' }] },
    ...
    { id: 'm_calf', mus: 'Waden / Add.',  konten: ['Waden', 'Adduktoren'], type: 'mr', sets: [1, 1, 1], rest: 10, reps: '6×4', free: 1, ex: [{ n: '' }, { n: '' }] },
