        ...
        <label class="ci menue">
          <span class="menue-computer" aria-hidden="true">
            <svg viewBox="0 0 62 55" preserveAspectRatio="none">
              ...
              <rect class="menue-computer-schatten" x="6" y="5" width="53" height="47" rx="7" fill="#7560E6" mask="url(#menue-fenster-ausschnitt)"/>
              <g class="menue-computer-front">
                ...
                <text class="menue-computer-text" x="28.5" y="32.5" fill="#111111" font-family="'Work Sans',sans-serif" font-size="9.6" font-style="italic" font-weight="900" text-anchor="middle" dominant-baseline="middle">MENÜ</text>
              </g>
            </svg>
          </span>
