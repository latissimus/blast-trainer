      ...
      <div class="seitenkopf">
        ...
        <details class="faq"><summary>Was zeigt das Set-O-Meter?</summary>
          <div class="faq-a">
            ...
            <p><b>Ein indirekter Satz wird als 1 angezeigt, aber in der Gesamtbelastung mit 0,5 gewichtet.</b> Ein Satz Rudern erscheint deshalb als ein indirekter Satz für Bizeps und Lat; in „Zusammen" und im Balken trägt er dort jeweils 0,5 bei. Tippst du einen Muskel an, siehst du <b>direkte Sätze</b>, <b>indirekte Sätze</b> und die gewichtete Summe <b>zusammen</b>.</p>
            <p><b>Tippe einen Muskelbalken an und wähle „Priorität setzen".</b> Die Priorität gibt diesem Muskel auf jedem Level einen zusätzlichen Pump-Satz. Du kannst sie bereits vormerken, bevor du die konkrete Pump-Übung im Log ausgewählt hast; die zusätzliche Eingabezeile erscheint sofort im passenden leeren Pumpfeld.</p>
