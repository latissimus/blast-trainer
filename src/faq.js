      ...
      <div class="seitenkopf">
        ...
        <details class="faq"><summary>Wie benutze ich die App?</summary>
          <div class="faq-a">
            ...
            <p><b>3. Wochenvolumen planen.</b> Ziehe den Log am Seitenanfang etwas nach unten. Die violette <b>Set-O</b>-Lasche klappt unter dem Header auf und ist vollständig antippbar. Beim ersten Öffnen der App zeigt sie sich einmal kurz als Hinweis. Tippe im Set-O-Mat einen Muskel an und setze ihn bei Bedarf direkt in seiner Zeile auf Priorität. Das geht schon, bevor du eine Pump-Übung gewählt hast.</p>
        ...
        <details class="faq"><summary>Was zeigt das Set-O-Meter?</summary>
          <div class="faq-a">
            ...
            <p>Danach entscheidest du zwischen <b>Umverteilen</b> und <b>Aufschlagen</b>. Umverteilen bedeutet: +1 Satz für den Zielmuskel und −1 Satz in einem von dir bestätigten, nicht priorisierten Pumpblock derselben Einheit. Die Vorschläge stehen nach gewichteter Wochenarbeit, dann direkter Arbeit und schließlich verfügbarer Satzanzahl. Daneben kannst du jeden zulässigen Pumpblock frei wählen; die App entscheidet nie selbst. Aufschlagen erhöht das Gesamtvolumen bewusst um einen Satz.</p>
            <p><b>Prioritäten wirken auch auf Level I.</b> Ziel und Spender können schon als leere Pumpfelder reserviert werden. Zusammengefasste Log-Blöcke bleiben in der Auswahl feldgenau: „Schultern + Abs“ wird als „Schulter“ und „Abs“ getrennt angeboten, „Brust + Rücken“ als „Brust“ und „Rücken“. Innerhalb desselben Feldes bleiben Lat und oberer Rücken gemeinsam „Rücken“, die drei Schulterköpfe gemeinsam „Schulter“. Die Bilanz bleibt immer +1/−1.</p>
