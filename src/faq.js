      ...
      <div class="seitenkopf">
        ...
        <details class="faq"><summary>Wie benutze ich die App?</summary>
          <div class="faq-a">
            ...
            <p><b>3. Wochenvolumen planen.</b> Ziehe die Log-Seite am Anfang etwas nach unten oder tippe auf den kleinen Abwärtspfeil über dem ersten Trainingsblock. So erscheint der Set-O-Meter-Link unter dem Header. Tippe dort einen Muskel an und setze ihn bei Bedarf auf Priorität. Das geht schon, bevor du eine Pump-Übung gewählt hast.</p>
        ...
        <details class="faq"><summary>Was zeigt das Set-O-Meter?</summary>
          <div class="faq-a">
            <p>Wie viel Arbeit jeder Muskel <b>in dieser Woche</b> abbekommt — als Balken, absteigend sortiert. Zu öffnen durch Herunterziehen am Anfang der Log-Seite, über den kleinen Abwärtspfeil oder über das Menü rechts in der unteren Leiste.</p>
            ...
            <p><b>Direkte und indirekte Sätze werden jeweils als ganzer Satz angezeigt.</b> Ein Satz Rudern ist ein direkter Satz für den oberen Rücken und je ein indirekter Satz für Bizeps und Lat. Die getrennte Beschriftung zeigt bereits, welche Rolle der Muskel hatte. Tippst du einen Muskel an, siehst du <b>direkte Sätze</b>, <b>indirekte Sätze</b> und <b>zusammen</b>.</p>
            <p><b>Tippe einen Muskelbalken an und wähle „Priorität setzen".</b> Die Priorität gibt diesem Muskel auf jedem Level einen zusätzlichen Pump-Satz. Du kannst sie bereits vormerken, bevor du die konkrete Pump-Übung im Log ausgewählt hast.</p>
